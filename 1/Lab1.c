...
int main(void)
{
  ...
  while (1)
  {
	  for(int i=0;i<20;i++){
		  ...
		  else if(HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_1)==GPIO_PIN_RESET || HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_0)==GPIO_PIN_RESET)
		  {
		  	  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_13,GPIO_PIN_RESET);
			  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8,GPIO_PIN_RESET);
		  ...
		  if(i<10) HAL_GPIO_WritePin(GPIOC, GPIO_PIN_6,GPIO_PIN_SET);
		  HAL_Delay(TIME);
		  if(i>10) HAL_GPIO_WritePin(GPIOC, GPIO_PIN_6,GPIO_PIN_RESET);
	  }
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PE2 PE3 PE15 PE0
                           PE1 */
  GPIO_InitStruct.Pin = GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_15|GPIO_PIN_0
                          |GPIO_PIN_1;
